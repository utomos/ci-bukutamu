...
<html lang="en">
    ...
    <body>
        <div class="container">
            <h1>Hello, ini ubah data buku tamu!</h1>
            <div class="row">
                <div class="col-lg-4">
            ...
            <div class="well">
                <form role="form" method="post" action="<?php echo base_url(); ?>guest/edit/<?php echo $this->uri->segment(3); ?>">
                    <?php foreach ($show->result() as $row) { ?>
                    <div class="form-group">
                        <label>Nama : </label>
                        <input type="hidden" name="id" value="<?php echo $row->id; ?>" class="form-control">
                        <input type="text" name="nama_buku" value="<?php echo $row->nama_buku; ?>" class="form-control" placeholder="Nama">
                    </div>
                    <div class="form-group">
